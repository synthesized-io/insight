...
def _test_value(value, x, equal=True):
...
def test_categorical():
    value = CategoricalValue(name='categorical', num_categories=8, embedding_size=64)
...
def test_continuous_positive():
    ...
    _test_value(value=value, x=np.asarray([0.1, 1.0, 10.0, 100.0]), equal=False)
