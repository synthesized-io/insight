...
# @pytest.fixture
# def test_data(nominal_data, ordinal_data, scale_data, date_data):
#     return pd.concat((nominal_data[0], ordinal_data[0], scale_data[0], date_data[0]), axis=1)


# @pytest.fixture
# def test_data_meta(nominal_data, ordinal_data, scale_data, date_data):
#     return [nominal_data[1], ordinal_data[1], scale_data[1], date_data[1]]
