...
from synthesized_insight.metrics import (Accuracy, ConfusionMatrix, F1Score,
                                         MeanAbsoluteError, MeanSquaredError,
                                         PRCurve, Precision,
                                         PredictiveModellingScore, R2Score,
                                         Recall, ROCCurve)
from synthesized_insight.metrics.modelling_metrics import (
    classifier_scores, classifier_scores_from_df, predictive_modelling_score,
