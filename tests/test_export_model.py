...
def test_continuous_variable_generation():
    ...
    with HighDimSynthesizer(df=df_original) as synthesizer:
        ...
        synthesizer.export_model(temp_dir + 'synthesizer.txt')

    synthesizer2 = HighDimSynthesizer.import_model(temp_dir + 'synthesizer.txt')
    df_synthesized = synthesizer2.synthesize(num_rows=len(df_original))
