...
from synthesized_insight.metrics.statistical_tests import BinomialDistanceTest

from .base import TwoColumnMetric, TwoColumnMetricTest
from .utils import bootstrap_binned_statistic, bootstrap_statistic

# # 'limits' is a tuple of the left and right limit of the conidence interval
# # 'level' is the confidence interval level on which the limits were computed
# ConfidenceInterval = namedtuple('ConfidenceInterval', ['limits' 'level'])
