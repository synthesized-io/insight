...
ext_modules = [
    Extension(f.replace('/', '.').replace('\\', '.')[:-3], [f]) for f in source_files('src/synthesized_insight')
]

setup(
    name='synthesized-insight',
    version=__version__,
    description='synthesized.io',
    long_description=long_description,
    url='https://github.com/synthesized-io/synthesized_insight',
