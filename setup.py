...
# so synth __init__ can detect if it's being loaded in the setup
# routine, so it won't load submodules that haven't yet been built.
builtins.__SYNTHESIZED_SETUP__ = True

# metadata
DISTNAME = 'Synthesized'
DESCRIPTION = 'Constraints-preserving data pipelines'

MAINTAINER = 'Synthesized'
MAINTAINER_EMAIL = 'baldin.np@gmail.com'
LICENSE = 'MIT'

# import restricted version
import Synthesized
VERSION = Synthesized.__version__
...
class CleanCommand(clean):
    ...
    # this is mostly in case we ever add a Cython module to synth
    def run(self):
        clean.run(self)
