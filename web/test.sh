...
curl -i -XPOST -H 'Content-Type: application/json' -d '{"username": "user", "password": "123", "invite_code": "FEQPFZAPACEKZFWM"}' ${BASE_URL}/users
TOKENS_JSON=$(curl -f -XPOST -H "Content-Type: application/json" -d '{"username": "user", "password": "123"}' ${BASE_URL}/login)
