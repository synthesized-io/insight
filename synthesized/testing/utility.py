    ...
    def estimate_utility(self, classifier=LogisticRegression(), regressor=LinearRegression()):
        ...
        for i, y_column in enumerate(y_columns):
            ...
            if dtypes[y_column] != DisplayType.CATEGORICAL:
                ...
                edges = UtilityTesting._bin_edges(df_orig[y_column])
                df_orig[categorical_y_column] = UtilityTesting._to_categorical(df_orig[y_column], edges)
                df_test[categorical_y_column] = UtilityTesting._to_categorical(df_test[y_column], edges)
                df_synth[categorical_y_column] = UtilityTesting._to_categorical(df_synth[y_column], edges)
